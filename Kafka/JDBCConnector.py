...
#logs here-/var/log/journal
# psql classroom-Databasename
#check if connector alive or not :curl http://localhost:8083/connectors

KAFKA_CONNECT_URL = "http://localhost:8083/connectors"
CONNECTOR_NAME="streaming-kafka"
